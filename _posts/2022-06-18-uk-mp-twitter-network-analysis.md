...
*Originally published in 2021 on my old website.*
...
![](/assets/images/uk-mp-twitter-network-analysis/figure1v7.png){:class="img-somewhat-large"} 
...
![](/assets/images/uk-mp-twitter-network-analysis/Overallnetwork4.png){:class="img-large"}
...
![](/assets/images/uk-mp-twitter-network-analysis/table3.png){:class="img"}
...
![](/assets/images/uk-mp-twitter-network-analysis/figure4v2.png){:class="img-somewhat-large"}
...
![](/assets/images/uk-mp-twitter-network-analysis/Labournetwork5.png){:class="img-large"}
*Table 7: Labour network of mutual followers - coloured by modularity class*
...
![](/assets/images/uk-mp-twitter-network-analysis/Torynetwork3.png){:class="img-large"}
*Table 7: Conservative network of mutual followers - coloured by modularity class*
